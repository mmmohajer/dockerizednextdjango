...
from core.models import UserModel, ProfileModel, NotificationTokenModel, UserEventModel, UnsucessfulLoggedInAttemptModel
...
admin.site.register(UnsucessfulLoggedInAttemptModel,
                    user_event_admin.UnsucessfulLoggedInAttemptAdmin)
